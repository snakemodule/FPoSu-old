...
ConVar OsuKeyBindings::MOVE_FORWARD("osu_key_move_forward", (int)KEY_W);;
ConVar OsuKeyBindings::MOVE_BACKWARD("osu_key_move_backward", (int)KEY_S);;
ConVar OsuKeyBindings::MOVE_LEFT("osu_key_move_left", (int)KEY_A);;
ConVar OsuKeyBindings::MOVE_RIGHT("osu_key_move_right", (int)KEY_D);;
