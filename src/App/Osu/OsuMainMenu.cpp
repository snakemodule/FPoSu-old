...
UString OsuMainMenu::MCOSU_MAIN_BUTTON_TEXT = UString("FPoSu");
UString OsuMainMenu::MCOSU_MAIN_BUTTON_SUBTEXT = UString("Practice Client");
#define MCOSU_MAIN_BUTTON_BACK_TEXT " "
...
OsuMainMenu::OsuMainMenu(Osu *osu) : OsuScreen()
{
	...
	UString versionString = "McOsu ";
	versionString.append(MCOSU_VERSION_TEXT);
	versionString.append(" ");
	versionString.append(Osu::version->getString());
	versionString.append(" by McKay. Modded by SnakeModule.");
