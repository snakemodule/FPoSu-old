...
OsuOptionsMenu::OsuOptionsMenu(Osu *osu) : OsuScreenBackable(osu)
{
	...
	addSection("Graphics");
	addSubSection("");
	CBaseUISlider *fovSlider = addSlider("Horizontal FOV:", 45.0f, 130.0f, convar->getConVarByName("fposu_fov"));
	...
	**************************************************************************************************************************/
	...
	//addSpacer();
	addSubSection("DPI");
	m_DPITextbox = addTextbox(convar->getConVarByName("fposu_mouse_dpi")->getString(), convar->getConVarByName("fposu_mouse_dpi"));
	addSubSection("cm per 360");
	m_cm360Textbox = addTextbox(convar->getConVarByName("fposu_mouse_cm_360")->getString(), convar->getConVarByName("fposu_mouse_cm_360"));
	...
	/*addSubSection("Keys - Movement");
	addKeyBindButton("Forward", &OsuKeyBindings::MOVE_FORWARD)->setClickCallback( fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onKeyBindingButtonPressed) );
	addKeyBindButton("Backward", &OsuKeyBindings::MOVE_BACKWARD)->setClickCallback( fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onKeyBindingButtonPressed) );
	addKeyBindButton("Left", &OsuKeyBindings::MOVE_LEFT)->setClickCallback( fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onKeyBindingButtonPressed) );
	addKeyBindButton("Right", &OsuKeyBindings::MOVE_RIGHT)->setClickCallback( fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onKeyBindingButtonPressed) );*/
	addSpacer();
	...
	//addSlider("Distance:", 0.1f, 3.0f, convar->getConVarByName("fposu_distance"))->setKeyDelta(0.01f);
